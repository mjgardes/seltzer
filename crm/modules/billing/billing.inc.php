...
//            }
            if ($_GET['cid'] == user_id()) {
                $useDefaultPaymentProcessor = variable_get('useDefaultPaymentProcessor', 0);
                //Default to newest implementation
                if($useDefaultPaymentProcessor >= 0) {
                    require_once('modules/stripe_payment/stripe_entrypoint.php');
                    connectToStripe();
                }
                else {
